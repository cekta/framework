...
- [Обработчик и параметры в url](http/handler_with_params.md)
- [Middleware для маршрута](http/middlewares.md)
- [Middleware для всего приложения](http/middlewares_application.md)

# HTTP: 404 NOT FOUND
- [Handler (Обработчик)](http/404/handler.md)
- [Middleware](http/404/middleware.md)
