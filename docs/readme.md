...
**-s dev** это временное решение, пока нет стабильной версии решения, потом будет убрано.  
**\--ignore-platform-reqs** стандартный образ не содержит ext_socket нужный для http сервера
...
Вы можете создать [HTTP обработчик](./http/handler.md), а также [cli command](./cli/command.md) или любой другой раздел 
данной документации.
